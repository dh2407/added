...
ALTER TABLE ONLY "public"."ParentChildSubjectsLink"
    ADD CONSTRAINT "ParentChildSubjectsLink_pkey" PRIMARY KEY ("parentId", "childId");

ALTER TABLE ONLY "public"."Subject"
    ADD CONSTRAINT "Subject_pkey" PRIMARY KEY ("id");

ALTER TABLE ONLY "public"."ParentChildSubjectsLink"
    ADD CONSTRAINT "ParentChildSubjectsLink_childId_fkey" FOREIGN KEY ("childId") REFERENCES "public"."Subject"("id");

ALTER TABLE ONLY "public"."ParentChildSubjectsLink"
    ADD CONSTRAINT "ParentChildSubjectsLink_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES "public"."Subject"("id");

ALTER TABLE "public"."ParentChildSubjectsLink" ENABLE ROW LEVEL SECURITY;
